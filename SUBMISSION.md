...
| T14  |     | [TBD]    | Added multi-stage Dockerfile (node:20-alpine build + nginx:alpine serve) and .dockerignore inside team-site/. Uses npm ci from lockfile. Image serves static Vite output on port 80.    |
| T15  |     | [TBD]    | Added feature flag utility and conditionally rendered LearningVelocity component; populated `/status` with redacted safe evidence. |
| T16  |     |          |                                                                                                                                                                                          |
| T17  |     |          |                                                                                                                                                                                          |
| T18  |     |          |                                                                                                                                                                                          |
| T19  |     |          |                                                                                                                                                                                          |
